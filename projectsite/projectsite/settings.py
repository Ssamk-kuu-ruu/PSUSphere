...
SECRET_KEY = 'django-insecure-&fvv5%1zsw5+wrm171c!mjh@z4kvzdwb7*jjc1^673+@_otb2y'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['jrntrpsc.pythonanywhere.com', 'localhost', '127.0.0.1']
...
ACCOUNT_AUTHENTICATED_LOGIN_REDIRECTS = False # keep /accounts/login/ visible even for signed-in users
